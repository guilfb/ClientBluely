...
<script src="resources/js/js_verif.js" type="text/javascript"></script>
        ...
        <div class="container">
            <div class="well">
                ...
                <div class="form-group">
                    ...
                    <input id="adresse" type="text" class="form-control" name="adresse" value="">
                </div>
                <div class="form-group">
                    <label for="cpostal">Code postal</label>
                    <input id="cpostal" type="text" class="form-control" name="cpostal" value="">
                </div>
                <div class="form-group">
